    ...
    <>
      <section className='md:mx-auto max-w-7xl px-4 sm:px-10 md:px-8 py-10'>
        <div className='flex flex-col gap-y-5'>
          <h1 className='text-[var(--white-primary)] font-bold tracking-[0.6px] text-[33px] sm:text-[40px]  md:text-start md:text-[34px] lg:text-[40px] leading-[40px] md:leading-[36px] lg:leading-[54px]'>Hi, I am <GradientText tag="span" text="Binoy Prasad" /> </h1>
